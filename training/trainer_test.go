...
func Test_BoundedRegression(t *testing.T) {
	...
	for _, f := range funcs {
		...
		trainer.Train(n, data, nil, 5000, time.Hour, nil)
...
func Test_RegressionLinearOuts(t *testing.T) {
	...
	trainer.Train(n, squares, nil, 25000, time.Hour, nil)
...
func Test_Training(t *testing.T) {
	...
	trainer.Train(n, data, nil, 1000, time.Hour, nil)
...
func Test_CrossVal(t *testing.T) {
	...
	trainer := NewTrainer(NewSGD(0.5, 0.1, 0, false), 0)
	trainer.Train(n, data, data, 1000, time.Hour, nil)
...
func Test_or(t *testing.T) {
	...
	trainer.Train(n, permutations, permutations, 25, time.Hour, nil)
...
func Test_xor(t *testing.T) {
	...
	trainer.Train(n, permutations, permutations, 500, time.Hour, nil)
